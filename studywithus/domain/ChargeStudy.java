...
public class ChargeStudy implements Serializable {
  ...
  private List<ChargeStudy> chargeInterestList; // 유료 스터디 관심목록
  private List<ChargeStudy> paymentStudyList; // 유료 스터디 결제내역(목록)
  ...
  public List<ChargeStudy> getChargeInterest() {
    return chargeInterestList;
  }

  public void setChargeInterest(List<ChargeStudy> chargeInterestList) {
    this.chargeInterestList = chargeInterestList;
  }

  public List<ChargeStudy> getPaymentStudyList() {
    return paymentStudyList;
  }

  public void setPaymentStudyList(List<ChargeStudy> paymentStudyList) {
