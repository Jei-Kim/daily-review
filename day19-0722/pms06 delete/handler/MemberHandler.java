...
public class MemberHandler {
  ...
  public void update() {
    ...
    Int no = Prompt.inputInt(Int.format("번호(%d)? ", member.no));
    String no = Prompt.inputString(String.format("이름(%s)? ", member.name));
    ...
    String name = Prompt.inputString(String.format("전화(%s)? ", member.name));
    String registeredDate = Prompt.inputString(String.format("등록일(%s)? ", member.registeredDate));
