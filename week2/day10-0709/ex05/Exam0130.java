...
public class Exam0130 {
  public static void main(String[] args) {
    ...
    b = 5 + 6; // OK!
    // - 리터럴끼리 산술 연산한 결과도 리터럴로 간주한다. ----정해진 값 + 정해진 값 = 정해진 값 개념
    ...
    byte x = 5, y = 6, z; //z는 값이 없는 상태
    z = x; // OK!
    z = y; // OK!

    //z = x + y; // 컴파일 오류!
    // why? "자바의 정수 연산은 최소 단위가 4바이트이다."
...
// -- 어차피 jvm은 기본으로 32bit의 메모리를 사용하기 때문에(최근 os는 64bit) short로 하나 int로 하나 속도의 차이가 없음.
