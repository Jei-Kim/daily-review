...
public class Exam02 {
  public static void main(String[] args) {
    ...
    // - 장점
    //   - 기존 클래스의 소스 코드가 필요 없다. (클래스 파일만 있으면 됨)
    //   - 간단한 선언(Calculator2 extends Calculator)으로 상속 받겠다고 표시한 후
    //      새 기능만 추가하면 된다.
    //
    // - 단점
    //   - 일부 기능만 상속 받을 수 없다.
    ...
    c1.plus(5);      // Cal의 메서드이다(!!cal2의 메서드가 아님 주의!!)
    c1.multiple(2);  //Cal2의 메서드이다.
    c1.minus(2);    // Cal의 메서드이다(!!cal2의 메서드가 아님 주의!!)
    c1.divide(4);   //Cal2의 메서드이다.
