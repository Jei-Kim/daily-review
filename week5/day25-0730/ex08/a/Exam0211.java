...
/// private: 같은 클래스 내의 멤버들끼리만 접근 가능! 
...
public class Exam0211 {
  public static void main(String[] args) {
    ...
    //
    //    s1.sum = s1.kor + s1.eng + s1.math; // 컴파일 오류! not visible
    //    s1.aver = s1.sum / 4f; // 컴파일 오류!

    System.out.printf("%s, %d, %d, %d, %d, %.1f\n",
        //s1.name, s1.kor, s1.eng, s1.math, s1.sum(), s1.aver()); /// private의 문제: 값을 건드릴수 없는건 ㄱㅊ 근데 출력할수도 없음(해결책 위에)
