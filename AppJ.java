...
public class AppJ {
  ...
  private Menu createJobsCalendarManagementMenu() {
    ...
    jobscalendarManagementMenu.add(new MenuItem("생성", "//list"));
    jobscalendarManagementMenu.add(new MenuItem("조회", "//detail"));
    jobscalendarManagementMenu.add(new MenuItem("수정", "/"));
    jobscalendarManagementMenu.add(new MenuItem("삭제", "/"));
  ...
  private Menu createExamCalendarManagementMenu() {
    ...
    examcalendarManagementMenu.add(new MenuItem("생성", "//list"));
    examcalendarManagementMenu.add(new MenuItem("조회", "//detail"));
    examcalendarManagementMenu.add(new MenuItem("수정", "/"));
    examcalendarManagementMenu.add(new MenuItem("삭제", "/"));
